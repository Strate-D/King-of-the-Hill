...
/**
 * The interface for the GameInfo object
 *
 * @author Dennis
 */
public interface IGameInfo {
    ...
    /**
     * Checks and moves the player to the first position in the list to be sure
     * the player is always in the top left corner of the field
     *
    ...
    /**
     * doStep methode for the client, so the client can move the active units
